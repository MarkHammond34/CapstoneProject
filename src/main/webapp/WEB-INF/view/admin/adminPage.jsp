										...
										<li>
											<table
												...
												<tbody>
													...
													%>
													<tr>
														<td><%=recentUsers.get(i).getUserID()%></td>
														<td><%=recentUsers.get(i).getSchoolEmail()%></td>
														<td><%=recentUsers.get(i).getFirstName()%></td>
														<td><%=recentUsers.get(i).getLastName()%></td>
														<td>T<%=recentUsers.get(i).getDateCreated()%></td>
													</tr>
													<%
														}
														} else {
											...
											<table
												...
												<tbody>
													<tr>
														...
														<td><%=recentListings.get(j).getName()%></td>
														<td><%=recentListings.get(j).getDateCreated()%></td>
													</tr>
													<%
														}
														} else {
