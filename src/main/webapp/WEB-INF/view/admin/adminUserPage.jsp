	...
	<div class="uk-cover-container uk-height-viewport">
		<div class="uk-flex uk-flex-column">
			<ul uk-switcher hidden>
				<li><a href="#dashboardUserTable" hidden></a>Users</li>
				<li><a href="#dashboardListingsTable" hidden></a>Listings</li>
			</ul>
			<div
					...
					<div class="uk-overflow-auto">
						<div class="uk-child-width-3-4" uk-grid>
							<div class="uk-overflow-container">
								<a class="uk-button uk-button-default uk-position-top-right"
									href="#createUserModal" uk-toggle>Create User</a>
								<h3 class="uk-heading-divider">Users</h3>
								<table
									class="uk-table uk-table-small uk-table-hover u-table-middle uk-table-divider">
									<thead>
										<tr>
											<th>ID</th>
											<th>Email</th>
									...
									<tbody>
										...
										<tr>
											...
											<td><%=allUsers.get(i).getSchoolEmail()%></td>
											<td><%=allUsers.get(i).getFirstName()%></td>
											<td><%=allUsers.get(i).getLastName()%></td>
											<td>
												<%
