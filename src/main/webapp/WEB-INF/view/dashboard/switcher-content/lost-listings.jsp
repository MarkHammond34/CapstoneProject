<li>
    <script>
        function lostListingsDashboardLoad(){
            $("#lostListingsLoad:hidden").show();
            var text="";
            $.ajax({
                url: 'dashboardLostListings',
                type: 'GET',
                dataType: 'json',
                ...
                success: function (result) {
                    ...
                    if(Object.keys(result).length == 0){
                        text += '<li class="uk-position-center"><h2>You have no listings you lost</h2></li>';
                    }else{
                    ...
                    $("#lostListings").empty();
                    $("#lostListingsLoad").hide();
                    $("#lostListings").append(text);
                }
            });
        }
    </script>
    <div
        ...
        <div id="lostListingsLoad" class="uk-position-center" uk-spinner="ratio: 3"></div>
        <a class="uk-icon-button uk-position-top-right" onclick="lostListingsDashboardLoad()"><span uk-icon="refresh" ></span></a>
        <ul id="lostListings" class="uk-nav uk-nav-default uk-child-width-1-4@m uk-grid-small uk-grid-match list" uk-grid>
