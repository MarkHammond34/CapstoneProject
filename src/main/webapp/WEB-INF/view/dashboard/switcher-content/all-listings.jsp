<li class="uk-active">
    <script>
        $(window).on('load', function () {
            allListingsDashboardLoad();
        });

        function allListingsDashboardLoad(){
            $("#allListingsLoad:hidden").show();
            var text="";
            $.ajax({
                url: 'dashboardAllListings',
                type: 'GET',
                dataType: 'json',
        ...
        <div id="allListingsLoad" class="uk-position-center" uk-spinner="ratio: 3"></div>
        <a class="uk-icon-button uk-position-top-right" onclick="allListingsDashBoardLoad()"><span uk-icon="refresh" ></span></a>
        <ul id="allListings" class="uk-nav uk-nav-default uk-child-width-1-4@m uk-grid-small uk-grid-match list" uk-grid>
