<li>
    <script>
        function activeListingsDashboardLoad(){
            $("#activeListingsLoad").show();
            var text="";
            $.ajax({
                url: 'dashboardActiveListings',
                type: 'GET',
                dataType: 'json',
    ...
    <div
        ...
        <div id="activeListingsLoad" class="uk-position-center" uk-spinner="ratio: 3"></div>
        <a class="uk-icon-button uk-position-top-right" onclick="activeListingsDashBoardLoad()" ><span uk-icon="refresh" ></span></a>
        <ul id="activeListings" class="uk-nav uk-nav-default uk-child-width-1-4@m uk-grid-small uk-grid-match list" uk-grid>
