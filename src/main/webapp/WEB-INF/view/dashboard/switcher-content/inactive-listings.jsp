<li>
    <script>
        function inactiveListingsDashboardLoad(){
            $("#inactiveListingsLoad").show();
            var text="";
            $.ajax({
                url: 'dashboardInactiveListings',
                type: 'GET',
                dataType: 'json',
                ...
                success: function (result) {
                    ...
                    $("#inactiveListingsLoad").hide();
                    $("#inactiveListings").append(text);
    ...
    <div
        ...
        <div id="inactiveListingsLoad" class="uk-position-center" uk-spinner="ratio: 3"></div>
        <a class="uk-icon-button uk-position-top-right" onclick="inactiveListingsDashBoardLoad()" ><span uk-icon="refresh" ></span></a>
        <ul id="inactiveListings" class="uk-nav uk-nav-default uk-child-width-1-4@m uk-grid-small uk-grid-match list" uk-grid>
