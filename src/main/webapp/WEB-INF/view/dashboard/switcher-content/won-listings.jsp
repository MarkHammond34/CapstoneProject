<li>
    <script>
        function wonListingsDashboardLoad(){
            $("#wonListingsLoad:hidden").show();
            var text="";
            $.ajax({
                url: 'dashboardWonListings',
                type: 'GET',
                dataType: 'json',
                ...
                success: function (result) {
                    ...
                    if(Object.keys(result).length == 0){
                        text += '<li class="uk-position-center"><h2>You have no listings you won</h2></li>';
                    }else{
                    ...
                    $("#wonListings").empty();
                    $("#wonListingsLoad").hide();
                    $("#wonListings").append(text);
                }
            });
        }
    </script>
    <div
        ...
        <div id="wonListingsLoad" class="uk-position-center" uk-spinner="ratio: 3"></div>
        <a class="uk-icon-button uk-position-top-right" onclick="wonListingsDashboardLoad()"><span uk-icon="refresh" ></span></a>
        <ul id="wonListings" class="uk-nav uk-nav-default uk-child-width-1-4@m uk-grid-small uk-grid-match list" uk-grid>
