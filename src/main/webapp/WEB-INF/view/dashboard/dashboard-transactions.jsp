					...
					<c:forEach var="transaction" items="${transactions}">
						<tr>
							<td><img class="uk-preserve-width uk-border-circle"
								...
								src="${pageContext.request.contextPath}/resources/img/profile-pic/${transaction.buyer.image_path}"
								height="auto" width="40" alt=""></td>
							<td><img class="uk-preserve-width uk-border-circle"
								uk-tooltip="${transaction.seller.username}"
								src="${pageContext.request.contextPath}/resources/img/profile-pic/${transaction.seller.image_path}"
								height="auto" width="40" alt=""></td>
