                    ...
                    <div class="uk-width-1-3" uk-grid>
                        <div class="uk-padding-small"
                            ...
                            <p class="uk-text-small uk-text-center">
                                <i>Name:</i> ${listing.user.firstName} ${listing.user.lastName}</p>
                            <p class="uk-text-small uk-text-center"><i>School Email:</i> ${listing.user.schoolEmail}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="uk-card uk-card-default uk-margin-large-left">
                <div class="uk-card-body uk-grid" uk-grid>
                    <div class="uk-width-1-3">
                        <h3><u>Date:</u> Friday, February 23rd</h3>
                        <h3><u>Time:</u> 3pm</h3>
                        <h3><u>Location:</u> Krasa Center</h3>
                    </div>
                    <div class="uk-width-2-3">
            ...
            <div class="uk-card uk-card-default uk-margin-large-right">
                ...
                <div class="uk-card-body">
                    <table class="uk-table">
                        ...
                        <tr>
                            <td class="uk-float-left">Tax</td>
                            <td class="uk-float-right">$${listing.highestBid * 0.08}</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
                    ...
                    <table class="uk-table">
                        ...
                        <tr>
                            ...
                            <td class="uk-float-right">
                                <span class="uk-badge"
                                      style="background-color: green; color: white;">$${listing.highestBid + (listing.highestBid * 0.08)}</span>
                            </td>
                        </tr>
                        </tbody>
                    </table>
            ...
            <div class="uk-card uk-card-default uk-margin-large-right">
                ...
                <div class="uk-card-body">
                    <table class="uk-table">
                        <tbody>
                        <tr>
                            <td class="uk-float-left">PayPal</td>
                            <td class="uk-float-right">
                                <button class="uk-button uk-button-primary uk-button-small" id="paypal-button">Complete
                                    Purchase
                                </button>
                            </td>
                        </tr>
                ...
                payment: function (data, actions) {
                    ...
                    return actions.payment.create({
                        payment: {
                            transactions: [{
                                amount: {
                                    total: ${listing.highestBid + (listing.highestBid * 0.08)},
                                    currency: 'USD'
                                }
                            }]
                        }
