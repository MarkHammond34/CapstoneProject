...
-->
	<div
		class="uk-card uk-card-default uk-grid-collapse uk-child-width-1-3@s uk-margin"
		uk-grid>
		...
		<div class="uk-card-body uk-width-2-3">
			<div class="watch-item uk-position-medium uk-position-top-right"
				id="${listing.id}">
				...
				<ul class="uk-list uk-list-large uk-list-divider">
					<li class="listing-title">
						<div class="listing-title">
							<i class="glyphicon glyphicon-user"></i> <span>${listing.user.username}</span>
						</div>
					</li>
					<li class="listing-user">
						<div class="listing-user">
							<i class="glyphicon glyphicon-usd"></i> <span>${listing.price}</span>
						</div>
					</li>
