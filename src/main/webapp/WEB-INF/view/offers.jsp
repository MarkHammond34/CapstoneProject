							...
							<header class="uk-comment-header uk-grid-medium uk-flex-middle"
								...
								<div class="uk-width-expand">
									...
									<ul
										...
										<li><a href="${pageContext.request.contextPath}/acceptOffer?offererID=${offer.userID.userID}&listing=${offer.listingID.id}" style="color: green;">Accept</a><span
											class="uk-margin-small-right" uk-icon="check"></span></li>
										<li><a href="${pageContext.request.contextPath}/rejectOffer?offererID=${offer.userID.userID}&listing=${offer.listingID.id}" style="color: red;">Reject</a><span
