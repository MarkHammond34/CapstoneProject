	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<h2>Welcome to U List It</h2>
				<p>These terms and conditions outline the rules and regulations
					for the use of U List It's Website.</p>
				<br />
				<p>By accessing this website we assume you accept these terms
					and conditions in full. Do not continue to use U List It's website
				...
				<p>The following terminology applies to these Terms and
					...
					meeting the Clien's needs in respect of provision of the Company's
				...
				<h2>Cookies</h2>
				<p>We employ the use of cookies. By using U List It's website
					you consent to the use of cookies in accordance with U List It's
					privacy policy.</p>
				...
				<h2>License</h2>
				<p>Unless otherwise stated, U List It and/or it's licensors own
					the intellectual property rights for all material on U List It. All
					intellectual property rights are reserved. You may view and/or
					print pages from http://www.u-listit.com for your own personal use
					subject to restrictions set in these terms and conditions.</p>
				<p>You must not:</p>
				<ol>
					<li>Republish material from http://www.u-listit.com</li>
					<li>Sell, rent or sub-license material from
						http://www.u-listit.com</li>
					<li>Reproduce, duplicate or copy material from
						http://www.u-listit.com</li>
				</ol>
				<p>Redistribute content from U List It (unless content is
				...
				<ol>
					...
					<li>Certain parts of this website offer the opportunity for
						...
						data ('Comments') in areas of the website. U List It does not
						...
						ofU List It, its agents or affiliates. Comments reflect the view
						and opinion of the person who posts such view or opinion. To the
						extent permitted by applicable laws U List Itshall not be
						...
						on this website.</li>
					<li>U List Itreserves the right to monitor all Comments and to
					...
					<li>You hereby grant to <strong>U List It</strong> a
				...
				<ol>
					<li>The following organizations may link to our Web site
						...
						<ol>
							...
							<li>Systemwide Accredited Businesses except soliciting
				...
				<ol start="2">
					...
					<li>We may consider and approve in our sole discretion other
						...
						<ol>
							...
							<li>associations or other groups representing charities,
								including charity giving sites,</li>
				...
				<p>These organizations may link to our home page, to
					publications or to other Web site information so long as the link:
					(a) is not in any way misleading; (b) does not falsely imply
					sponsorship, endorsement or approval of the linking party and it
					products or services; and (c) fits within the context of the
				...
				<p>
					...
					sending an e-mail to <a href="mailto:ulistit@gmail.com"
						title="send an email to ulistit@gmail.com">ulistit@gmail.com</a>.
				...
				<p>Approved organizations may hyperlink to our Web site as
					follows:</p>

				<ol>
					<li>By use of our corporate name; or</li>
					<li>By use of the uniform resource locator (Web address) being
						linked to; or</li>
					<li>By use of any other description of our Web site or
						material being linked to that makes sense within the context and
						format of content on the linking party's site.</li>
				</ol>
				<p>No use of U List It’s logo or other artwork will be allowed
				...
				<p>
					This Terms and conditions page was created at <a
