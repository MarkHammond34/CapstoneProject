...
<body>
	...
	<div id="central" class="uk-width-4-5 uk-align-center">
		...
		<ul class="uk-list uk-list-striped uk-grid-small">
			...
			<li class="uk-width-1-1">Dry-erase wall calendar/board Mini toolkit (including
				screwdriver, hammer, wrench)</li>
			<li class="uk-width-1-1">Picture hangers (double-sided tape for concrete walls)</li>
		</ul>
		<h2>Linens/Laundry Supplies</h2>
		<ul class="uk-list uk-list-striped uk-grid-small">
			<li class="uk-width-1-1">Sheets and pillowcases (2 sets. Check with college for size
				needed - some college twin beds are extra long.)</li>
			<li class="uk-width-1-1">Towels (3 each of bath, hand and face)</li>
			<li class="uk-width-1-1">Pillows (2)</li>
			<li class="uk-width-1-1">Mattress pad (check with college for size needed)</li>
			<li class="uk-width-1-1">Blankets (2)</li>
			<li class="uk-width-1-1">Comforter/bedspread</li>
			<li class="uk-width-1-1">Clothes hangers</li>
			<li class="uk-width-1-1">Laundry bag/basket Laundry detergent, fabric softener and
				stain remover</li>
		...
		<ul class="uk-list uk-list-striped uk-grid-small">
			<li class="uk-width-1-1">Electronic storage media such as memory cards and USB flash
				drives</li>
			<li class="uk-width-1-1">Stapler and staples</li>
			<li class="uk-width-1-1">Printer paper (if you decide to bring a printer)</li>
			<li class="uk-width-1-1">Pencil holder and sharpener</li>
			<li class="uk-width-1-1">Stackable desk trays (at least 4)</li>
		</ul>
		<h2>Electronics</h2>
		<ul class="uk-list uk-list-striped uk-grid-small">
			<li class="uk-width-1-1">Laptop (printer is optional; there are usually computer labs
				where you can print)</li>
			<li class="uk-width-1-1">Portable speakers (if you want to play music from laptop/MP3
				player)</li>
			<li class="uk-width-1-1">HDMI cord, Ethernet cord for computer (check if your room
				has wireless)</li>
		...
		<ul class="uk-list uk-list-striped uk-grid-small">
			...
			<li class="uk-width-1-1">Coffeemaker/hot pot/microwave, if allowed</li>
			<li class="uk-width-1-1">Small refrigerator (if one isn't provided)</li>
