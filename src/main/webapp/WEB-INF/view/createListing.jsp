...
<div uk-grid>
    <div class="uk-width-1-4">
        <div id="premiumHint"
             class="uk-card uk-card-default uk-card-large uk-card-body uk-width-1-4 uk-padding-small uk-text-center"
             style="position: fixed; bottom: 20%; left: 10px; display: none;" onclick="togglePremiumHint();">
            <p>For a fee of 5% of what you earn from your listing, your listing will appear in the <b>Premium
                Listings</b> section of the homepage.</p>
            <i>* Fees will be applied if and only
                if the listing is sold.</i>
            <p>
                <a href="faqs.jsp">Click here for more info.</a></p>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function togglePremiumHint() {
        if (document.getElementById('premiumHint').style.display == 'inline') {
            document.getElementById('premiumHint').style.display = 'none';
        } else {
            document.getElementById('premiumHint').style.display = 'inline'
        }
    }
</script>
