...
// IE 11
    ...
    function hasClass(element, cls) {
        return supports.ClassList && toNodes(element).some(function (element) {
...
// default strategy
    ...
    function listen(cb) {
        ...
        return new Promise(function (resolve) {
            ...
            once(win, 'message', function (_, data$$1) {
    ...
    function Navbar(UIkit) {
        ...
        UIkit.component('navbar', {
            ...
            update: function update() {
                ...
                UIkit.drop(
                    $$(((this.dropdown) + " ." + (this.clsDrop)), this.$el).filter(function (el) {
...
function refreshCountdowns() {
    ...
    var bidForms = document.getElementsByClassName("bid-form");
    var pickUpForms = document.getElementsByClassName("pick-up-form")
    ...
    for (var i = 0; i < days.length; i++) {
        ...
        if (days[i].innerText != "00") {
            ...
            if (bidForms[i] != null) {
                bidForms[i].style.display = "none";
            }
            if (pickUpForms[i] != null) {
                pickUpForms[i].style.display = "inline";
            }
        }
    }
}
